...
|OpenSSL|[build-for-android.sh](https://github.com/leleliu008/auto/blob/master/OpenSSL/build-for-android.sh)|将[OpenSSL](http://blog.fpliu.com/it/software/OpenSSL)构建为[Android](http://blog.fpliu.com/it/os/Android)可以使用的so的[POSIX Shell](http://blog.fpliu.com/it/software/sh)脚本|
